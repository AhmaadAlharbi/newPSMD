...
class BatteryController extends Controller
{
    ...
    public function index(){
        ...
        return view('battery.admin.dashboard',compact('tasks','task_details','date','monthName'));

    }
     //// start front END functions
     public function add_task(){
        $stations = Station::all();
        return view ('battery.admin.tasks.add_task',compact('stations'));
    }
    ...
    public function getEngineersEmail($eng_id){
        return (string) Engineer::where("section_id",3)
        ->where('id',$eng_id)
        ->first();
    }
    ...
    public function showAllTasks(){
        $tasks = Task::where('fromSection',3)->orderBy('id', 'desc')
        ->get();
    ...
    public function showEngineers(){
        $engineers = Engineer::where('section_id',3)->get();
