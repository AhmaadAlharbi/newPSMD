                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('Transformers.user.taskDetails',['id'=>$task->id])}}"
                                        class=" btn btn-info">Details</a></td>
                                <td>
                                    @if($task->status == 'pending')
                                    <a href="{{route('Transformers.engineerReportForm',['id'=>$task->id])}}"
                                        class="btn btn-danger">Action
                                        Take</a>
                                </td>
                                @endif
                                @if($task->status == 'completed')
                                <a href="{{route('Transformers.user.veiwReport',['id'=>$task->id])}}"
