                ...
                <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$task->station_name}}</td>


                            @if($task->control == "JAHRA CONTROL CENTER")
                            <td class="table-warning">{{$task->control}}
                            </td>
                            @elseif($task->control == "JABRIYA CONTROL CENTER")
                            <td class="table-info">{{$task->control}}
                            </td>
                            @elseif($task->control == "TOWN CONTROL CENTER")
                            <td class="table-danger">{{$task->control}}
                            </td>
                            @elseif($task->control == "SHUAIBA CONTROL CENTER")
