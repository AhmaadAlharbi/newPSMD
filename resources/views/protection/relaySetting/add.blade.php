    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card border border-primary">
                <div class="card-body">
                    <form action="{{ route('protection.submitRS') }}" method="post" enctype="multipart/form-data"
                          autocomplete="off">
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        <div class="row m-3">
                            ...
                            <div class="col-lg-4">
                                ...
                                <input list="ssnames" class="form-control" value="" name="station_name" id="ssname"
                                       onchange="getStation(),getEngineer(),getEquip()" type="search">
                                <datalist id="ssnames">
                        ...
                        <div class="row m-3">
                            <div class="col-6">
                                ...
                                <input list="engineers" onchange="getEngineerEmail()" name="engineer" class="form-control"
                                       id="engineer" type="search">
                            ...
                            <div class=" col-lg-12">
                                <label>اخر موعد للتسليم</label>

                                <input name="deadline" class="form-control fc-datepicker" name="invoice_Date" placeholder="YYYY-MM-DD"
                                       type="text" value="{{ date('Y-m-d') }}" required>
                            </div>
                        </div>
...
@section('js')
    ...
    <!--PROTECTION JS fiLE-->
    <script type="text/javascript" src="{{ URL::asset('js/protection/general-check.js') }}"></script>
@endsection
