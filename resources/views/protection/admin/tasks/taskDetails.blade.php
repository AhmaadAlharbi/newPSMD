                            ...
                            <div class="panel-body tabs-menu-body main-content-body-right border">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab3">
                                        <div class="table-responsive mg-t-40">
                                            ...
                                            <table
                                                ...
                                                <tr>
                                                    <th class="border-bottom-0">رمز المحطة </th>
                                            ...
                                            <table class="table center-aligned-table mb-0 table-hover"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="table-secondary">
                                                        ...
                                                        <td>
                                                            <span class="badge badge-pill badge-success">{{ $x->status
                                                                }}</span>
                                                        </td>
                                                        @else
                                                        <td>
                                                            <span class="badge badge-pill badge-danger">{{ $x->status
                                                                }}</span>
                                            ...
                                            <table class="table center-aligned-table mb-0 table-hover"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="table-light">
                                                        ...
                                                        @else
                                                        <td>
                                                            <span class="badge badge-pill badge-warning">{{ $x->status
                                                                }}</span>
                                    ...
                                    <div class="tab-pane" id="tab7">
                                        @isset($report)
                                        <a href="{{route('protection.veiwReport',['id'=>$report->task_id])}}"
