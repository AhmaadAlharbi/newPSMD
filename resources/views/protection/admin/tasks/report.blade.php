                    ...
                    <div class="container">
                        ...
                        <div class="table-responsive text-left">
                            ...
                            <div class="d-block border border-dark  mb-2   text-dark">
                                <h3 class=" bg-warning-gradient py-2 text-white pl-4">Alarm Date - {{$task_details->tasks->task_date}}</h3>
                            ...
                            <div class="  border border-dark      mb-2  text-dark">
                                <h3 class="bg-success-gradient py-3 text-white pl-4 ">Report Date - {{$task_details->report_date}}</h3>
