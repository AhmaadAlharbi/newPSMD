            ...
            <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                <div class="">
                    <h6 class="mb-3 tx-16 "><a class="text-white"
                            href="{{route('protection.engineerPageTask',['id'=>Auth::user()->email])}}">
                            مهماتي
                        </a>
                    </h6>
                </div>
            ...
            <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                <div class="">
                    <h6 class="mb-3 tx-16 text-white"><a class="text-white"
                            href="{{route('protection.engineerPageTaskUncompleted',['id'=>Auth::user()->email])}}">مهماتي
                            الغير
                            منجزة</a></h6>
                </div>
                <div class="pb-0 mt-0">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
        <div class="card overflow-hidden sales-card bg-success-gradient">
            <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                ...
                <div class="">
                    <h6 class="mb-3 tx-16 "><a class="text-white"
                            href="{{route('protection.engineerPageTaskCompleted',['id'=>Auth::user()->email])}}"> تقاريري
                        </a> </h6>
                </div>
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                                    ...
                                    <div class="media-body">
                                        <div class="d-flex align-items-center">
                                            <div class="mt-0">
                                                ...
                                                <a href="{{route('protection.user.taskDetails',['id'=>$task->id])}}"
