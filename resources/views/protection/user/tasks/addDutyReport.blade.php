...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="card border border-primary">
            <div class="card-body">
                <form action="{{ route('protection.submitDutyReport') }}" method="post" enctype="multipart/form-data"
                    autocomplete="off">
                    {{ csrf_field() }}
                    {{-- 1 --}}
                    <div class="row m-3">
                        ...
                        <div class="col-lg-4">
                            <label>يرجى اختيار المحطة</label>
                    ...
                    <div class="row m-3">
                        <div class="col">
                            <label for="exampleTextarea">التقرير</label>
