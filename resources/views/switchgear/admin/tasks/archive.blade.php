            ...
            <div class="table-responsive">
                ...
                <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $i }}</td>
                            <td><a href="{{ route('switch.admin.taskDetails', ['id' => $task->task_id]) }}">{{
                                    $task->tasks->refNum }}</a>
                            </td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu tx-13">
                                        <a class="dropdown-item"
                                            href="{{ route('switch.changeSectionView', ['id' => $task->task_id]) }}"><i
                                                class="text-warning fas fa-fast-forward"></i>&nbsp;&nbsp;
                                            تحويل لقسم آخر
                                        </a>
                                        @if ($task->status === 'completed')
                                        <a class="dropdown-item"
                                            href="{{ route('switch.veiwReport', ['id' => $task->task_id]) }}"><i
