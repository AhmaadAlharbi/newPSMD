                    ...
                    <div class="d-flex">
                        <div class="">
                            <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                ...
                                date('m'))->where('section_id',6)->count()}}
                            </h4>
                    ...
                    <div class="d-flex">
                        <div class="">
                            <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                ...
                                6)->orWhere('toSection', 6)->where('status', 'pending')->count() }}
                            </h4>
                        ...
                        <span class="float-right my-auto mr-auto">
                            ...
                            <span class="text-white tx-16 op-7">
                                ...
                                {{ round((\App\Models\Task::where('status', 'pending')->where('fromSection', 6)->count()
                                /\App\Models\Task::count()) *100) }}%
                                @endif
                            </span>
                        </span>
                    </div>
            ...
            <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                ...
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                        <div class="">
                            <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                {{ \App\Models\TaskDetails::where('section_id', 6)->whereMonth('created_at',
                                date('m'))->count() }}
                            </h4>
                            </h4>
