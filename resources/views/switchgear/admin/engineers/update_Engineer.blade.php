    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{route('switch.admin.updateEngineer',['id'=>$engineer->user_id])}}" enctype="multipart/form-data"
                ...
                method="post" autocomplete="off">
                    ...
                    <div class="modal-body">
                        ...
                        <label for="shift_id" class="control-label ">shft</label>
