                ...
                <div class="card-body">
                    ...
                    <div class="container">
                        ...
                        <div class="text-left">
                            ...
                            <form action="{{ route('switch.submitEditReport', ['id' => $tasks->id]) }}"
                                ...
                                <div class="    my-2  text-dark">
                                    ...
                                    <textarea name="action_take" placeholder="Write Your Report here"
                                        ...
                                        class="form-control">{{$tasks_details->action_take}}</textarea>
                                        ...
                                        <table id="example1" class="table key-buttons text-md-nowrap"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ $i }}</td>
                                                    <td><a
                                                            href="{{ route('switch.admin.taskDetails', ['id' => $task->id]) }}">{{
                                                            $task->tasks->refNum }}</a>
                                                    </td>
                                                    <td>{{ $task->tasks->station->SSNAME }}</td>
                                                    <td>{{ $task->sectionID->section_name }}</td>
                                                    <td>{{ $task->users->name }}</td>
                                                    <td><a href="{{ route('switch.viewCommonReport', ['id' => $task->task_id, 'section_id' => $task->sectionID->id]) }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="{{ route('switch.engineerReportUnCompleted', ['id' => $tasks->id]) }}" method="post">
                        {{ csrf_field() }}
                </div>
...
<!--PROTECTION JS fiLE-->
<script type="text/javascript" src="{{ URL::asset('js/switch/app.js') }}"></script>
@endsection