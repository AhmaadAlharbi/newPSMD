        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('switch.submitEditReport',['id'=>$tasks->id])}}" enctype="multipart/form-data"
                                            ...
                                            <div class="container">
                                                <div class="table-responsive mg-t-40">
                                                    <h2 class="text-center m-2 text-primary">إدارة صيانة محطات التحويل
                                                        الرئيسية</h2>
                                                    <a href="{{route('protection.user.homepage')}}"
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <div class="table-responsive mt-15">
                                                            <table class="table center-aligned-table mb-3  table-hover"
