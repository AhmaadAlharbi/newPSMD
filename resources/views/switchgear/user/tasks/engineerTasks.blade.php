                ...
                <div class="table-responsive">
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$i}}</td>
                                <td><a href="{{route('switch.user.taskDetails',['id'=>$task->id])}}">{{$task->refNum}}</a>
                                </td>
                                ...
                                <td><a href="{{route('switch.user.taskDetails',['id'=>$task->id])}}"
                                        class=" btn btn-outline-info">Details</a></td>
                                <td>
                                    @if($task->status == 'pending')
                                    <a href="{{route('switch.engineerReportForm',['id'=>$task->id])}}"
                                        class="btn btn-danger">Action
                                        Take</a>
                                </td>
                                @endif
                                @if($task->status == 'completed')
                                <a href="{{route('switch.user.veiwReport',['id'=>$task->id])}}"
