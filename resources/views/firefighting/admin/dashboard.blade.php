...
<div class="breadcrumb-header justify-content-between">
    <div class="left-content">
        <div>
            <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">لوحة تحكم إدارة مهمات قسم مكافحة الحرائق</h2>
        </div>
    </div>
</div>
<!-- /breadcrumb -->
            ...
            <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                <div class="">
                    <h6 class="mb-3 tx-16 "><a class="text-white"
                            href="{{route('FireFighting.admin.showAllTasks')}}">عرض
                            كافة
                    ...
                    <div class="d-flex">
                        <div class="">
                            <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                {{\App\Models\Task::whereMonth('created_at', date('m'))->where('fromSection',4)->count()}}
            ...
            <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                <div class="">
                    <h6 class="mb-3 tx-16 text-white"><a class="text-white"
                            href="{{route('FireFighting.admin.pendingTasks')}}">المهمات الغير
                            منجزة</a></h6>
                </div>
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                        <div class="">
                            <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                {{\App\Models\Task::where('status','pending')->where('fromSection',4)->count()}}
                            </h4>
                        ...
                        <span class="float-right my-auto mr-auto">
                            ...
                            <span class="text-white tx-16 op-7">
                                ...
                                {{round((\App\Models\Task::where('status','pending')->where('fromSection',4)->count()/\App\Models\Task::count())*100)}}%
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
        <div class="card overflow-hidden sales-card bg-success-gradient">
            <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                ...
                <div class="">
                    <h6 class="mb-3 tx-16 "><a class="text-white"
                            href="{{route('FireFighting.admin.completedTasks')}}">المهمات
                            المنجزة</a> </h6>
                </div>
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                        <div class="">
                            <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                {{\App\Models\Task::where('status','completed')->where('fromSection',4)->whereMonth('created_at', date('m'))->count()}}
                            </h4>
                            </h4>
                        ...
                        <span class="float-right my-auto mr-auto">
                            ...
                            <span class="text-white tx-18 op-7">
                                @if(\App\Models\Task::count()!==0)
                                {{round((\App\Models\Task::where('status','completed')->where('fromSection',4)->count()/\App\Models\Task::count())*100)}}%
                                @endif
                            </span>
                        </span>
                    </div>
            ...
            <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                <div class="">
                    <h6 class="mb-3 tx-16 text-white">
                        <a class="text-white" href="{{route('FireFighting.admin.archive')}}">ارشيف التقارير</a>
                    </h6>
                    </h6>
                </div>
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                        <div class="">
                            <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                {{\App\Models\Task::where('status','completed')->where('fromSection',4)->count()}}
                            </h4>
                            ...
                            <div class="media-body">
                                <div class="d-flex align-items-center">
                                    <div class="mt-0">
                                        ...
                                        <a href="{{route('FireFighting.admin.taskDetails',['id'=>$task->id])}}"
                                        ...
                                        <a class="text-left btn btn-success "
                                            href="{{route('FireFighting.updateTask',['id'=>$task->id])}}"
                ...
                <ul class="timeline-1 mb-0 ">
                    <li class="mt-0 mb-0 "> <i class="icon-note icons bg-primary-gradient text-white product-icon"></i>
                        ...
                        <a class="btn btn-info mt-2 text-center"
                            href="{{route('FireFighting.veiwReport',['id'=>$task_detail->task_id])}}">Report</a>
                        <a class="btn btn-outline-dark mt-2 text-center"
                            href="{{route('FireFighting.admin.taskDetails',['id'=>$task_detail->task_id])}}">Details</a>
                    </li>
                </ul>
