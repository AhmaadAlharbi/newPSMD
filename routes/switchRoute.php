...
Route::get('View_file/{id}/{file_name}', [SwitchGearController::class, 'open_file'])->name('view_file');
Route::get('download/{id}/{file_name}', [SwitchGearController::class, 'get_file']);
